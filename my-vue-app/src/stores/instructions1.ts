export const instructions: Record<number, string> = {
  ...
  1011: `Describe the Principle of the molecular signaling: What general signaling mechanism or rule does this pathway follow (e.g., receptor activation, cascade, feedback)?`,
